...
Pod::Spec.new do |s|
  s.name             = 'ATDownLoader'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ATDownLoader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Spaino/ATDownLoader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Spaino' => 'captain_spaino@163.com' }
  s.source           = { :git => 'https://github.com/Spaino/ATDownLoader.git', :tag => s.version.to_s }
